...
function alt_nulle()
{
	document.getElementById("alt_errore").innerHTML="";	
	document.getElementById("alt_errore").style.display="none";
}
function validate()
{
	if (document.DetailForm.name.value=="Your Name*" || document.DetailForm.name.value=="")
	{
		alt_null();	
	...
	//------EMAIL-------------
	if(document.DetailForm.email.value=="Your Email*" || document.DetailForm.email.value=="")
	{
		alt_null();
		document.getElementById("alt_error").style.display="block";
	...
	//---Mobile No---
	if (document.DetailForm.contact.value=="Phone Number*" || document.DetailForm.contact.value=="")
	{
		alt_null();
		document.getElementById("alt_error").style.display="block";
	...
	DetailForm.submitform.disabled = true;
    DetailForm.submitform.value = "Please wait...";
	document.DetailForm.action = "submit.php";
...
function validate_enquiry()
{
	...
	{
		alt_null();	
		document.getElementById("alt_errore").style.display="block";
        document.getElementById("alt_errore").innerHTML="Please Enter Your Name";
	...
	else if(document.EnquireForm.name.value!="")
	{
		...
		if (ValidChars.indexOf(Char) != -1) 
			{
				...
				alt_null();
				document.getElementById("alt_errore").style.display="block";
				document.getElementById("alt_errore").innerHTML="Please Enter Valid Your Name";					
				document.EnquireForm.name.focus();
		...
		if (char1=="false")
		{
			alt_null();
			document.getElementById("alt_errore").style.display="block";
            document.getElementById("alt_errore").innerHTML="Enter Valid Your Name";
		    document.EnquireForm.name.focus();
			document.EnquireForm.name.select();
	        return false;
		}
		...
		if(mytext=="")
    	{
    		alt_null();
			document.getElementById("alt_errore").style.display="block";
            document.getElementById("alt_errore").innerHTML="Please Enter Your Your Name";
    		document.EnquireForm.name.focus();
    		return false;
    	}
        var strcnt2=mytext.length;
        if(strcnt2<2 || strcnt2>50)
    	{
            alt_null();
			document.getElementById("alt_errore").style.display="block";
            document.getElementById("alt_errore").innerHTML="Your Name Accept 2-50 Characters Only";
			document.EnquireForm.name.focus();
			document.EnquireForm.name.select();
	        return false;
       }
	...
	if(document.EnquireForm.email.value=="Your Email*" || document.EnquireForm.email.value=="")
	{
		alt_null();
		document.getElementById("alt_errore").style.display="block";
        document.getElementById("alt_errore").innerHTML="Please Enter Your Email Id";
	...
	if(document.EnquireForm.email.value!="")
	{
		...
		if(eflag!=document.EnquireForm.email.value)
		{
			alt_null();
			document.getElementById("alt_errore").style.display="block";
            document.getElementById("alt_errore").innerHTML="Please Enter a Valid Email Id";
			document.EnquireForm.email.select();
			document.EnquireForm.email.focus();
			return false;
		}
        ...
        if(mytext=="")
        {
            alt_null();
			document.getElementById("alt_errore").style.display="block";
            document.getElementById("alt_errore").innerHTML="Please Enter Email Id";
	        document.EnquireForm.email.focus();
			document.EnquireForm.email.select();
	        return false;
        } 
	...
	if (document.EnquireForm.contact.value=="Phone Number*" || document.EnquireForm.contact.value=="")
	{
		alt_null();
		document.getElementById("alt_errore").style.display="block";
		document.getElementById("alt_errore").innerHTML="Please Enter Phone Number";
	...
	if (document.EnquireForm.contact.value!="")
	{
		...
		if (number=="false")
		{
	    	alt_null();
			document.getElementById("alt_errore").style.display="block";
	        document.getElementById("alt_errore").innerHTML="Mobile No. Accept Digits Only";
			document.EnquireForm.contact.focus();
		...
		if(strcnt2!=10)
		{
			alt_null();
			document.getElementById("alt_errore").style.display="block";
			document.getElementById("alt_errore").innerHTML="Enter 10 Digit Mobile No.";
			document.EnquireForm.contact.focus();
			document.EnquireForm.contact.select();
			return false;
		}
	...
	if (document.EnquireForm.location.value=="Your Location*" || document.EnquireForm.location.value=="")
	{
		alt_null();	
		document.getElementById("alt_errore").style.display="block";
        document.getElementById("alt_errore").innerHTML="Please Enter Your Location";
	...
	else if(document.EnquireForm.location.value!="")
	{
		...
		if (ValidChars.indexOf(Char) != -1) 
			{
				...
				alt_null();
				document.getElementById("alt_errore").style.display="block";
				document.getElementById("alt_errore").innerHTML="Please Enter Valid Your Location";					
				document.EnquireForm.location.focus();
		...
		if (char1=="false")
		{
			alt_null();
			document.getElementById("alt_errore").style.display="block";
            document.getElementById("alt_errore").innerHTML="Enter Valid Your Location";
		    document.EnquireForm.location.focus();
			document.EnquireForm.location.select();
	        return false;
		}
		...
		if(mytext=="")
    	{
    		alt_null();
			document.getElementById("alt_errore").style.display="block";
            document.getElementById("alt_errore").innerHTML="Please Enter Your Your Location";
    		document.EnquireForm.location.focus();
    		return false;
    	}
        var strcnt2=mytext.length;
        if(strcnt2<2 || strcnt2>50)
    	{
            alt_null();
			document.getElementById("alt_errore").style.display="block";
            document.getElementById("alt_errore").innerHTML="Your Location Accept 2-50 Characters Only";
			document.EnquireForm.location.focus();
			document.EnquireForm.location.select();
	        return false;
       }
